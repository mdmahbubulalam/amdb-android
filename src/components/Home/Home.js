...
const Home = () => {
    ...
    const [topRatedMovie, setTopRatedMovie] = useState('Best Movie and Series of 2021');
      ...
      const pullPage = () =>{
        ...
        setRefreshing(true);
        setMovies(topRated);
        setTopRatedMovie('Best Movie and Series of 2021');
        setSearchValue('')
        setTimeout(()=>{
          setRefreshing(false);
        },1000)
                 ...
                 <View>
                   ...
                   <View>
                    ...
                    placeholder='Type to Search' 
                        style={styles.input}
                        onChangeText={(val) => val ? setSearchValue(val) : setMovies(topRated)}
                    />
                    </View>
                   </View>
                   <Text style={{fontSize: 15, color:'#ffffff',marginTop:8}}>{topRatedMovie}</Text>
                </View>
                ...
                
                {
                    ...
                    movies.map((movie,index) => (
                        <View key={index} style={styles.movieCard}>
                            ...
                            >
                                <View style={{backgroundColor:'#000000',borderRadius:5, padding:3}}>
                                    <Image 
                                    ...
                                    />
                                    <View style={{width: 180,padding:2}}>
                                        <Text ellipsizeMode='tail' numberOfLines={1} style={styles.titleText}>{movie.Title}</Text>
                                        <Text style={{fontSize: 15, color:'#ffffff'}}>{movie.Year}</Text>
                                        <Text style={{fontSize: 14, color:'#ffffff'}}>{movie.Type.toUpperCase()}</Text>
                                    </View>
                                </View>
                            </TouchableOpacity>
                        </View>
